...
class OrderDetailsSaveFoodBuseinessView extends StatelessWidget {
 ...
 List<Projects_Model> ProjectsList = [
  ...
  Widget build(BuildContext context) { var heightApp = MediaQuery.of(context).size.height;
    ...
    return  GetBuilder<OrderDetailsSaveFoodBusinessController>(
          init: OrderDetailsSaveFoodBusinessController(),
          initState: (_) {},
          builder: (_) {
            return
    Scaffold(
      ...
      appBar: AppBar(centerTitle: true,
        ...
        actions: [
          if (orderDetailsBusinessController.status != 'ملغي' &&
              orderDetailsBusinessController.status != 'مكتمل')
      ...
      body:  Container(
                ...
                child: Column(
                  children: [
                          ...
                          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color:
                                            orderDetailsBusinessController.status1 == 1
                                                ? Color(0XFFCCA750)
                                                : Color(0xffB0B0B0)
                                                    .withOpacity(.3)),
                                  ),
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color:
                                            orderDetailsBusinessController.status2 == 1
                                                ? Color(0XFFCCA750)
                                                : Color(0xffB0B0B0)
                                                    .withOpacity(.3)),
                                  ),
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color:
                                            orderDetailsBusinessController.status3 == 1
                                                ? Color(0XFFCCA750)
                                                : Color(0xffB0B0B0)
                                                    .withOpacity(.3)),
                                  ),
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color:
                                            orderDetailsBusinessController.status4 == 1
                                                ? Color(0XFFCCA750)
                                                : Color(0xffB0B0B0)
                                                    .withOpacity(.3)),
                                  ),
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color:
                                            orderDetailsBusinessController.status5 == 1
                                                ? Color(0XFFCCA750)
                                                : Color(0xffB0B0B0)
                                                    .withOpacity(.3)),
                                  )
                            ...
                            GestureDetector(
                              onTap: () {
                                ...
                                if (orderDetailsBusinessController.status ==
                                    'تحت الاجراء') {
                                  orderDetailsBusinessController.status =
                                      'السائق في الطريق إليك';
                                  orderDetailsBusinessController.status2 = 1;
                                } else if (orderDetailsBusinessController.status ==
                                    'السائق في الطريق إليك') {
                                  orderDetailsBusinessController.status = 'جاري الجمع';
                                  orderDetailsBusinessController.status3 = 1;
                                } else if (orderDetailsBusinessController.status ==
                                    'جاري الجمع') {
                                  orderDetailsBusinessController.status = 'تم الاستلام';
                              ...
                              child: Container(
                                ...
                                width: 368,
                                decoration: BoxDecoration(
                                  color: orderDetailsBusinessController.status ==
                                          'تحت الاجراء'
                                      ...
                                      : orderDetailsBusinessController.status ==
                                          ...
                                          : orderDetailsBusinessController.status ==
                                              ...
                                              : orderDetailsBusinessController.status ==
                                                  ...
                                                  ? Color(0xff41AC9C)
                                                      .withOpacity(.10)
                                                  : orderDetailsBusinessController
                                                              .status ==
                                                          'مكتمل'
                                                      ? Color(0xff97B73E)
                                                          .withOpacity(.10)
                                ...
                                child: Center(
                                  child: Text(
                                    orderDetailsBusinessController.status.toString(),
                                    style: TextStyle(
                                        color: orderDetailsBusinessController.status ==
                                                'تحت الاجراء'
                                            ? Color(0xffB0B0B0)
                            ...
                            if (orderDetailsBusinessController.status == 'مكتمل')
                              Padding(
                                padding:
                                  ...
                                  CarouselSlider(
                                    ...
                                    options: CarouselOptions(
                                        ...
                                        onPageChanged: (index, reason) {
                                          orderDetailsBusinessController.current =
                                              index;
                                          orderDetailsBusinessController.update();
                                        }),
                                  ),
                    ...
                    if (orderDetailsBusinessController.status == 'تحت الاجراء')
                      Align(
                    ...
                    else if (orderDetailsBusinessController.status == 'تم الاستلام')
                      Align(
                          alignment: FractionalOffset.bottomCenter,
                          child: Padding(
                            padding: const EdgeInsets.only(bottom: 40),
                            child: MainButton(
                                ...
                                press: () {
                                  showModalBottomSheet(
                                      ...
                                      builder: (BuildContext context) {
                                        return GetBuilder<
                                                OrderDetailsSaveFoodBusinessController>(
                                            init:
                                                OrderDetailsSaveFoodBusinessController(),
                                            initState: (_) {},
                                            builder: (_) {
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Column(
                                                            children: [
                                                              ...
                                                              MainButton(
                                                                text: 'إرسال',
                                                                press: orderDetailsBusinessController
                                                                            .rateController
                                                                            .text
                                                                            .trim()
                                                                            .toString() ==
                                                                ...
                                                                color: orderDetailsBusinessController
                                                                            .rateController
                                                                            .text
                                                                            .trim()
                                                                            .toString() ==
                    ...
                    else if (orderDetailsBusinessController.status == 'مكتمل')
                      Align(
                          alignment: FractionalOffset.bottomCenter,
                          child: Padding(
                              padding: const EdgeInsets.only(bottom: 40),
                                                              ...
                                                              MainButton(
                                                                ...
                                                                press: paymentController.salaryController.text ==
                                                                        ...
                                                                        paymentController.selectedCatIndex == 
                                                                            -1 &&paymentController.selectedCatIndex2 == 
                                                                          -1
                                                                    ? null
                                                                    : () {
